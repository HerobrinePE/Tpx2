...
# Discord App token
bbtoken = "NTAwNzYzMTMwMDkyMDYwNzAy.DqPliw.2sEeMIqMiEuLavjEOBnNm-j-BZA" #REMOVE TOKEN BEFORE SYNC!! -Blaze
...
pref = "+" #Command prefix
des = "For McpeTPX's Discord.py Bot" #Description shown on using the help command

# Error messages
err_mesg = ":x: **An error occurred!**"
err_mesg_pi = ":x: **This command can only be run when the bot is hosted on a Raspberry Pi lul.**"
