...
async def on_ready():
    ...
    if diff.days < 2:
        ...
        await client.change_presence(game=discord.Game(name="tpx.py | " + config.pref + "help | Python version: " + platform.python_version() + " | Discord.py API version: " + discord.__version__ + " | Running on: " + platform.system() + " " + platform.release() + " (" + os.name + ")"))
